...
import {useUserRegisterMutation} from "@/app/GlobalRedux/Auth/AuthAction";
...
export default function SingUpPage() {
    ...
    useEffect(() => {
        if(isSuccess){
            toast.success('Your registration successfully Done. You may login now.');
            router.push('/signin')
        }
        if(isError){
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 pt-1 h-[450px]">
            ...
            <div className="flex flex-wrap justify-items-center items-center my-10">
                ...
                >
                    ...
                    <small>#password length must be 6 digit.</small>
                    <Form.Item >
